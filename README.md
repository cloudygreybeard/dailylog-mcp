...
- **Activity Tracking**: Log activities, moods, notes, summaries with metadata
- **Search**: Text search with filtering by type, tags, mood, dates
...
**Core Logging:**
- `dailylog_entry` - Create new daily log entries (activities, moods, notes, summaries)
- `dailylog_get_entries` - Retrieve entries for specific dates or ranges
- `dailylog_search` - Search through logs by text, tags, mood, or criteria
- `dailylog_summarize` - Generate summaries for daily, weekly, monthly periods
- `dailylog_ai_assist` - AI assistance for wording, tags, mood analysis, insights
...
dailyctl log activity "Team meeting" --tags work,meeting --mood 8 --duration 60
dailyctl log mood "Feeling energetic" --mood 9
